        ...
        <div class="projects-grid">
          ...
          <div class="project-card">
            <div class="project-image project-carousel" data-carousel="projet5">
              <div class="carousel-track">
                  <video class="carousel-video" muted loop playsinline preload="none">
                    <source data-src="images/Projet1/1.webm" type="video/webm">
                  </video>                
          ...
          <div class="project-card">
            <div class="project-image project-carousel" data-carousel="projet2">
              <div class="carousel-track">
                  <video class="carousel-video" muted loop playsinline preload="none">
                    <source data-src="images/Projet2/1.webm" type="video/webm">
                  </video>
          ...
          <div class="project-card">
            <div class="project-image project-carousel" data-carousel="projet4">
              <div class="carousel-track">
                  <video class="carousel-video" muted loop playsinline preload="none">
                    <source data-src="images/Projet4/1.webm" type="video/webm">
                  </video>
